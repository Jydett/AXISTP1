...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements servicestub.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/AXISServer2_war_exploded/services/HelloWorld";
    ...
    public servicestub.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public servicestub.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servicestub.HelloWorldSoapBindingStub _stub = new servicestub.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicestub.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                servicestub.HelloWorldSoapBindingStub _stub = new servicestub.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
